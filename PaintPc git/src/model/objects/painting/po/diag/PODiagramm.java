 ...
 * @version %U%,%I%
 */
public class PODiagramm extends PaintObjectPen {
    ...
    public final BufferedImage paint(final BufferedImage _bi, 
        ...
        getPen().paintLine(pnt_first, new DPoint(pnt_first.getX(), 
                pnt_last.getY()), _bi, _final, _g, new DPoint(_x, _y));

        getPen().paintLine(pnt_first, new DPoint(pnt_last.getX(), 
                pnt_first.getY()), _bi, _final, _g, new DPoint(_x, _y));
        
        
        getPen().paintLine(pnt_last, new DPoint(pnt_first.getX(), 
                pnt_last.getY()), _bi, _final, _g, new DPoint(_x, _y));
