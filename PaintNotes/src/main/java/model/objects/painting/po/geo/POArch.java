 ...
 * @version %U%,%I%
 */
public class POArch extends POInsertion {
	 ...
	 */
	public POArch(final int _elementId, final Pen _pen, final Picture _pic) {
    ...
    public final BufferedImage paint(final BufferedImage _bi, 
        ...
        DPoint pnt_arch = new DPoint(
                getPnt_last().getX() - pnt_vector.getX() 
                * lengthTotal / length , 
                getPnt_last().getY() - pnt_vector.getY() 
                * lengthTotal / length);
